...
<BlockMath math="r = n \cdot \cos(k \cdot \theta + \phi)" />
...
<BlockMath math="\text{Number of petals} = \begin{cases} k & \text{if } k \text{ is odd} \\ 2k & \text{if } k \text{ is even} \end{cases}" />
...
<BlockMath math="x = x_0 + r \cdot \cos(\theta)" />
<BlockMath math="y = y_0 + r \cdot \sin(\theta)" />

Substituting r from our rose equation:

<BlockMath math="x = x_0 + n \cdot \cos(k\theta + \phi) \cdot \cos(\theta)" />
<BlockMath math="y = y_0 + n \cdot \cos(k\theta + \phi) \cdot \sin(\theta)" />
...
<BlockMath math="A = \int_{0}^{\pi/k} \frac{1}{2} r^2 d\theta = \frac{1}{2} \int_{0}^{\pi/k} n^2 \cos^2(k\theta) d\theta" />

Using the identity <InlineMath math="\cos^2(x) = \frac{1 + \cos(2x)}{2}" />:

<BlockMath math="A = \frac{n^2}{4} \int_{0}^{\pi/k} (1 + \cos(2k\theta)) d\theta" />
<BlockMath math="A = \frac{n^2}{4} \left[ \theta + \frac{\sin(2k\theta)}{2k} \right]_{0}^{\pi/k}" />
<BlockMath math="A = \frac{n^2}{4} \left( \frac{\pi}{k} + \frac{\sin(2\pi)}{2k} \right)" />
<BlockMath math="A = \frac{n^2 \pi}{4k}" />

For a unit rose (n = 1) with k = 5:

<BlockMath math="A = \frac{\pi}{20}" />
...
<BlockMath math="\text{bin width} = \frac{\text{sample rate}}{2 \times \text{fftSize}} = \frac{48000}{2048} \approx 23.4 \text{ Hz}" />
...
<BlockMath math="\text{band intensity} = \frac{1}{N} \sum_{i=1}^{N} \frac{\text{dataArray}[i]}{255}" />
...
<BlockMath math="S = S_{\text{base}} \cdot M \cdot E \cdot P" />

Where M combines the musical components:

<BlockMath math="M = \beta_B \cdot B \cdot I_B + \beta_M \cdot M \cdot I_M + \beta_T \cdot T \cdot I_T" />
