---
title: 'Create a BlogPage'
date: 'Feb 8, 2024'
description: 'Create a BlogPage using MDX and Next.js'
readTime: 10
img: https://github.com/pranshu05/pranshu05/assets/70943732/99917dba-e928-4be3-ad80-cc881e676e87
---
                ...
                {posts.map((post) => (
                    <li className="my-2" key={post.slug}>
                        ...
                        >
                            ...
                            <div className="text-[#b4befe] text-sm">
    ...
    return (
        <div className="w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 2xl:w-1/2 mx-auto mt-32">
            <div className="pb-8">
                ...
                <div className="text-[#b4befe] flex items-baseline text-base">
