...
alert("Hello, World!");
//MDX doesn't provide any styling by default so I had to style evry different classes of MDX
```
...
> This is a quote text. And there's may more things I can do!!

---

So this is how it actually works. I changed the project file stucture so routing is done in the `./src/pages` directory.
...
Bazinga! And its done 😂. Thanks for reading my first blog \<3.
