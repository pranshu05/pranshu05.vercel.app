...
export const metadata: Metadata = {
    title: "Technical Blog Posts | Pranshu05",
    description,
    keywords: ["Technical Blog", "Programming", "Web Development", "React", "Next.js", "TypeScript", "JavaScript", "Tutorials", "Pranshu Patel"],
    alternates: {
        canonical: "/posts",
    },
    openGraph: {
...
function getPosts(): Post[] {
    ...
    try {
        ...
        console.error('Error writing RSS feed:', e)
    }
