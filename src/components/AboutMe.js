...
export const AboutMe = () => {
  ...
  const ageInYears = Math.floor((new Date() - BIRTHDATE) / MS_PER_YEAR)
  const ageInPoints = (new Date() - BIRTHDATE) / MS_PER_YEAR
  ...
  return (
    <div className="about-me" id="about-me">
      ...
      <p>
        I'm a {ageInYearsFormatted} year old high school student and self-taught
