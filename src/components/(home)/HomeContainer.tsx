...
const HomeContainer: React.FC = () => {
    ...
    return (
        <div className="w-11/12 md:w-4/5 lg:w-3/4 xl:w-3/5 max-w-3xl mx-auto">
            ...
            <div className="text-zinc-300 text-sm leading-relaxed mb-4 max-w-2xl space-y-3">
                <p>I keep a blog for work that does not fit in a README: walkthroughs of things I built or broke, performance and debugging stories where the fix was embarrassing in hindsight, and longer notes on React, Next.js, APIs, databases, and whatever toolchain I am wrestling with that month.</p>
                <p>Some posts are tutorials, some are experiments or visuals, and some are basically rubber ducks with syntax highlighting, mostly so future me can grep my own mistakes.{" "}<Link href="/posts" className="link">Read the posts</Link>{" "}when you want the full version.</p>
            </div>
