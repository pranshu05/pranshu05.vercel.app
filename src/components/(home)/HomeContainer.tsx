...
const HomeContainer: React.FC = () => {
    ...
    return (
        <div className="w-11/12 md:w-4/5 lg:w-3/4 xl:w-3/5 max-w-3xl mx-auto">
            ...
            <HomeImageGrid />
            <p className="text-zinc-300 text-sm leading-relaxed mt-8">I love to work on web development, and I&apos;m insterested in web3, Cloud Computing, DevOps, and CyberSecurity. I also enjoy contributing to <a aria-label='Links do not have a discernible name' className="link" href='https://github.com/pranshu05' target='_blank'>open-source projects</a> and writing <Link className='link text-zinc-100 hover:text-zinc-400 transition-colors' href='/posts'>technical blogs</Link>.</p>
        </div>
    )
}
