        ...
        <div className="w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 2xl:w-1/2 mx-auto">
            <div className="pb-8">
                <div className="flex items-baseline">
                    <h1 className="text-4xl font-bold text-[#74c7ec]">Pranshu Patel</h1>
                    <p className="text-sm px-1 text-[#b4befe]">(He/Him)</p>
                </div>
                <p className="text-[#b4befe]">{ageInYears}y/o Developer, India • {currentTime}</p>
            </div>
