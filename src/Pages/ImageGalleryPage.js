  ...
  return (
    <div>
      ...
      <div className="gallery-page-cont">
        <p className="go-back-home">&larr; <Link to="/">home.</Link></p>
        <h1>My Photography</h1>
        <p> Downloads: {profileInfo.downloads} | Views: {profileInfo.views} | <a href={`https://unsplash.com/@pranshu05`} target="_blank" rel="noopener noreferrer"> Visit my Unsplash Profile </a> </p>
